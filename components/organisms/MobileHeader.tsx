...
const MobileHeader = ({
  ...
  return (
    <header
      className={`z-10 top-0 left-0 w-full h-[60px] py-3 px-6 bg-white after:content-[''] after:absolute after:bottom-0 after:left-[1rem] after:right-[1rem] after:h-[1px] after:bg-customGray ${className}`}
    >
